  ...
  return (
    <Drawer open={isOpen}  style={{background: "#343A40"}} onClose={toggleDrawer} direction="right" size={320}>
        ...
        <div className="px-8 text-white">
            ...
            return (
              <Link to={menu.path} key={menu.id} className="flex items-center space-x-[2px] my-5">
        ...
        <div className="flex items-center mt-10">
          ...
          <button className="ml-2 bg-white hover:bg-gray-100 text-gray-800 py-[2] font-medium px-1 border border-gray-400 rounded">Submit</button>
        </div>

        <div className="text-center mt-20">
        <Link to="/" className="font-semibold main-header">PROSHOP</Link>
        </div>
